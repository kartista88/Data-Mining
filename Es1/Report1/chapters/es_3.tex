...
\begin{figure}[!tbp]
	\centering
	\subfloat[fig:$\lambda$ = 1 $\gamma$ = 1]{\includegraphics[width=0.45\textwidth]{kml1g1.png}}
	\hfill
	\subfloat[fig:$\lambda$ = 0,01 $\gamma$ = 1 Less smoothness]{\includegraphics[width=0.45\textwidth]{kml1g001.png}}
...
\begin{figure}[!tbp]
	\centering
	\subfloat[fig:$\lambda$ = 25 $\gamma$ = 1 More smoothness]{\includegraphics[width=0.45\textwidth]{kml1g25.png}}
	\hfill
	\subfloat[fig:$\lambda$ = 0,1 $\gamma$ = 10 More non linearity]{\includegraphics[width=0.45\textwidth]{kml10g01.png}}
